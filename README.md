...
It combines rule-based market scoring with machine learning, serves asynchronous analysis through a FastAPI API, and exposes Prometheuas metrics for operations.
